...
from companies_data_cleaned import companies_list   # use your cleaned ~7k list
...
if st.button("Fetch Data"):
    ...
    # ✅ Safeguard: handle empty or missing Ticker column
    if fin.empty or "Ticker" not in fin.columns:
        st.warning("No Yahoo Finance data returned for tickers in this industry.")
        st.stop()
